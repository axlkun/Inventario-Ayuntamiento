            ...
            '<div class="botonesTabla">' .
                '<div class="botonSeparacion">' .
                    '<a href="/inventario_ayuntamiento/ver-wifi.php?id='. $row['idwifi'] . '" class="boton-verde-tabla">'.
                        '<img class="icono" src="/inventario_ayuntamiento/src/img/icono3.svg" alt="">' .
                    '</a>' .
                '</div>' .

                '<div class="botonSeparacion" style="display: <?php if($rol){echo \'none\';} else{echo \'block\';} ?> ;">' .
                    '<a href="/inventario_ayuntamiento/actualizar-wifi.php?id='. $row['idwifi'] . '" class="boton-amarillo-tabla">' .
                        '<img class="icono" src="/inventario_ayuntamiento/src/img/icono4.svg" alt="">' . 
                    '</a>' .
                '</div>' .  
                
                '<div class="botonSeparacion" style="display: <?php if($rol){echo \'none\';} else{echo \'block\';} ?> ;">' .
                    '<a href="delete-wifi.php?id='. $row['idwifi'] . '" class=\'boton-rojo-tabla del-btn\'>'.
