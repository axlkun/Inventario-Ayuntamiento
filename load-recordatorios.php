        ...
        '<td>'.
            '<div class="botonesTabla">' .
                ...
                '<div class="botonSeparacion">' .
                    '<a href="/inventario_ayuntamiento/actualizar-recordatorio.php?id='. $row['idrecordatorios'] . '" class="boton-amarillo-tabla">' .
                        '<img class="icono" src="/inventario_ayuntamiento/src/img/icono4.svg" alt="">' . 
                    '</a>' .
                '</div>' .  
                
                '<div class="botonSeparacion">' .
                    '<a href="delete-recordatorio.php?id='. $row['idrecordatorios'] . '" class=\'boton-rojo-tabla del-btn\'>'.
