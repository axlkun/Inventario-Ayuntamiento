        ...
        <div class="contenedor contenido-header">
            <div class="barra">
                ...
                <div class="derecha">
                    ...
                    <a href="/inventario_ayuntamiento/registros-inventario-user.php">Inventario</a>
                        <a href="/inventario_ayuntamiento/registros-wifi-user.php">Wifi</a>
                        <a href="/inventario_ayuntamiento/registros-nodos-user.php">Nodos</a>
                        <a href="/inventario_ayuntamiento/registros-recordatorios-user.php">Recordatorios</a>
                        <a href="/inventario_ayuntamiento/cerrar-sesion.php">Cerrar sesión</a>
                    </nav>
